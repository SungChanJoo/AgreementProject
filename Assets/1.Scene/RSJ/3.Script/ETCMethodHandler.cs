...
public class ETCMethodHandler
{
    ...
    public void AddClientAnalyticsDataValue(List<string> filterDataList, AnalyticsData clientAnalyticsData)
    {
        ...
        // dataList[7] = "day1|calculation_level1_analytics|ReactionRate|AnswerRate|E|"
        // dataList[8] = "day1|calculation_level2_analytics|ReactionRate|AnswerRate|E|"
        // dataList[9] = "day1|calculation_level3_analytics|ReactionRate|AnswerRate|E|"
        ...
        for (int i = 0; i < filterDataList.Count; i++) // 0은 requestName
        {
